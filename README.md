...
- [Deferred purchase options (Pre-order / TBYB = Try-before-you-buy)](https://shopify.dev/docs/apps/selling-strategies/purchase-options/deferred) uses the similar APIs, and if you are interested in, check [this sample](https://github.com/benzookapi/shopify-deferred-purchase-sample-app), too.
